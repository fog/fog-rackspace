module Fog
  module Rackspace
    class Service
      def service_name
        fail Fog::Errors::NotImplemented.new('Please implement the #service_name method')
      end

      def region
        fail Fog::Errors::NotImplemented.new('Please implement the #region method')
      end
      ...
      def endpoint_uri(service_endpoint = nil, endpoint_name = nil)
        ...
        unless url
          if v1_authentication?
            fail "Service Endpoint must be specified via #{endpoint_name} parameter"
          else
            url = endpoint_uri_v2
          end
        end
      ...
      def authenticate(options = {})
        send authentication_method, options
      end
      ...
      def authenticate_v1(_options)
        fail Fog::Errors::NotImplemented.new('Authentication of legacy endpoints is not implemented for this service.')
      end
